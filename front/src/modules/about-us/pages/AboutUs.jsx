const AboutUs = () => {
    return (
        <>
            ...
            <h2 className="text-center animate__animated animate__flipInX">The app designers</h2>                
                <div className="d-flex my-4">                    
                    <div className="w-50">
                        ...
                        <p> Then we realized that if we had a space where the community could join and offer their places
                            in a space specially prepared for us, an app that shows only what we want to see, that would be
                            amazing!
                        </p>                  
                        <p> So we decided to design and create Board Games Friends, just for our community, with love and
                            understanding of the things we care about regarding board games.
                        </p>
                        <p>Just a gift for all who enjoy spending time playing and meeting with friends.</p>
                    </div>
                    <div className="w-50">
