    ...
    return (
        <>
            <div className="container ">
                ...
                <img className="w-100 animate__animated animate__rollIn" src={`${import.meta.env.VITE_API_AWS_URL}/SGoals-1-min.png`}/>  
                ...
                <img className="w-100 animate__animated animate__rollIn" src={`${import.meta.env.VITE_API_AWS_URL}/SGoals-2-min.png`}/>  
                <div className="my-5 animate__animated animate__rollIn">
                    <h5>APP barrierless</h5>
                    <p className="mt-3 fs-5">
                ...
                <img className="w-100" src={`${import.meta.env.VITE_API_AWS_URL}/SGoals-17-min.png`}/>  
                <div className="my-5">
                    <h5 className="mb-3" style={{fontStyle:"italic"}}><b>We think bigger!</b></h5>
                    <p className="fs-5">We want to grow with the community so our future plans will 
                    include improvements and new sections to the app. So all of us can find and join board game events, 
                    competitions, personalize sections for board gamers clubs, stores and much more!</p>
                    <p className="fs-5 mt-5"><b>And of course we want the Board Game Friends app to be free forever!</b></p>
